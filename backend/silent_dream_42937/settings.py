"""
Django settings for silent_dream_42937 project.
...
ROOT_URLCONF = 'silent_dream_42937.urls'
...
WSGI_APPLICATION = 'silent_dream_42937.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "silent_dream_42937 API",
    "DESCRIPTION": "API documentation for silent_dream_42937 App",
    "VERSION": "v1",
}
